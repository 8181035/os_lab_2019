...
int main(int argc, char **argv) 
{
  ...
  char servers[255] = {'\0'}; // TODO: explain why 255
    /* Полное имя файла может включать 260 сиволов, которое определенно коснстантой PATH_MAX.  
 Путь до файла, не считая корневого каталога не должен превышать 255 символов.*/
  char ip[255];
  FILE* file;
  while (true) 
    {
